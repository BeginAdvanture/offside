...
.order_table .th_column_1 {
  width: 21%;
}

.order_table .th_column_2 {
  width: 20%;
}

.order_table .th_column_3 {
  width: 20%;
}

.order_table .th_column_4 {
  width: 20%;
}

.order_table .th_column_5 {
  width: 19%;
}
...
<body>
  <div class="admin_content_wrap">
    <div class="admin_content_subject"><span>매치 현황</span></div>
    <div class="company_table_wrap">
      ...
      <c:if test="${listCheck != 'empty' }">
        <table class="order_table">
          ...
          <thead>
            <tr>
              <td class="th_column_1">매치 번호</td>
              <td class="th_column_2">매치 아이디</td>
              <td class="th_column_3">매치 날짜</td>
              <td class="th_column_4">매치 상태</td>
          ...
          <c:forEach items="${list}" var="list">
            <tr>
              ...
              <td>
                <c:if test="${list.orderState == '인원모집중' }">
